                        ...
                        @foreach ( $sociles as $sl=>$socile )
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('writter.socile.delete',$socile->id) }}" class="btn btn-danger btn-sm"><i class="fa fa-trash" aria-hidden="true"></i></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </table>
        ...
        <div class="card">
            <div class="card-body">
                <div class="card-title">
                    ...
                    <form action="{{ route('writter.socile.store') }}" method="post" id="mysocile">
                        @csrf
                        <div class="mb-3">

            ...
            <div class="slimscroll-menu" id="remove-scroll">
                ...
                <div class="user-box">
                    <div class="user-img">
                        ...
                        <img src="{{ Avatar::create(Auth::user()->name)->toBase64() }}" title="Mat Helme"
                        class="rounded-circle img-fluid"/>
                        @else
                        <img src="{{ asset('uploads/user') }}/{{ Auth::user()->photo }}" alt="user-img" title="Mat Helme"
                        class="rounded-circle img-fluid profile_round">
                            
                        @endif
                    </div>
                    <h5><a href="#">{{ Auth::user()->name }}</a> </h5>
                    <p class="text-muted">{{ Auth::user()->profetion }}</p>
                </div>
...
{{-- 
                        ...
                        <li>
                            <a href="javascript: void(0);"><i class="fi-layout"></i><span> Layouts </span> <span
                                    class="menu-arrow"></span></a>
                            <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li>
                            <a href="javascript: void(0);"><i class="fi-briefcase"></i> <span> UI Elements </span> <span
                                    class="menu-arrow"></span></a>
                            <ul class="nav-second-level" aria-expanded="false">
                        ...
                        {{-- <li>
                            <a href="javascript: void(0);"><i class="fi-disc"></i><span
                                    class="badge badge-info pull-right">10</span> <span> Forms </span></a>
                            <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li>
                            <a href="javascript:void(0);"><i class="fi-marquee-plus"></i><span
                                    class="badge badge-success pull-right">Hot</span> <span> Extra Pages </span></a>
                            <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li>
                            <a href="javascript: void(0);"><i class="fi-cog"></i> <span> Profile Satting </span> <span
                                    class="menu-arrow"></span></a>
                            <ul class="nav-second-level nav" aria-expanded="false">
                                <li><a href="{{ route('profile.edit') }}">Profile Update</a></li>
                                <li><a href="{{ route('student.socile') }}">Socile Icon</a></li>
                                <li><a href="{{ route('student.education') }}">Education Experience</a></li>
                                <li><a href="{{ route('student.password') }}">Password</a></li>
                            </ul>
                        </li>
                    ...
                    <ul class="list-unstyled topbar-right-menu float-right mb-0">
                        ...
                        <li class="dropdown notification-list">
                            <a class="nav-link dropdown-toggle nav-user" data-toggle="dropdown" href="#" role="button"
                                ...
                                @endif
                                <span class="ml-1">{{ Auth::user()->name }}<i

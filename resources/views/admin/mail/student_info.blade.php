                                    ...
                                    <td align="center" class="" valign="top">
                                        ...
                                        <table bgcolor="#fff" cellpadding="0" cellspacing="0" class=""
                                            ...
                                            <tbody style="margin-top: 15px;">
                                                ...
                                                <tr class="">
                                                    <td class="headline">Welcome to Librery!</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <center class="">
                                                                ...
                                                                <tbody class="">
                                                                    <tr class="">
                                                                        <td class=""
                                                                            ...
                                                                            <br><br>
                                                                            A property management application that helps
                                                                            you manage your real estate profile with
                                                                            ease and efficiency. <br><br>
                                                                            You have successfully been admition to use
                                                                            liberty as a <em>Landlord</em><br>
                                                                            <br>
                                                                            Your login credentials are provided below <b>dont share this pro code</b>:
                                                                            <br>
                                                                            <span style="font-weight:bold;">Pro code:
                                                                                &nbsp;</span><span
                                                                                style="font-weight:lighter;"
                                                                                class="">{{ $user_info->pro_code }}</span>
                                                                            <br></td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
